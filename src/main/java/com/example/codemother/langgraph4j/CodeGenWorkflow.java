...
import com.example.codemother.langgraph4j.node.*;
...
public class CodeGenWorkflow {
    ...
    /**
     * 构建路由：根据生成类型决定是否需要构建
     * HTML/MULTI_FILE -> skip_build，VUE_PROJECT -> build
     */
